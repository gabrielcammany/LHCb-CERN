...
public:
   ...
   void PrintHits()
   {
     ...
     /*    } */
     /*  } */
     std::cout<<"i"<<setw(15)<<"1/w"<<setw(15)<<"Xat0"<<setw(15)<<"Zat0"<<setw(15)<<"planeCode"<<setw(15)<<"zone"<<setw(15)<<"isX"<<setw(15)<<"dxDy"<<setw(15)<<"dzDy"<<setw(15)<<"Fraction"<<setw(15)<<"Chi2OnHit"<<setw(15)<<"Worst"<<std::endl;
      for(Int_t i =0; i<m_hits.size(); i++){
        //m_hits[i].PrintHit();
        if(i==j){
          std::cout<<i<<setw(15)<<sqrt(1./m_hits[i].w2())<<setw(15)<<m_hits[i].x(0.)<<setw(15)<<m_hits[i].z(0.)<<setw(15)<<m_hits[i].planeCode()<<setw(15)<<m_hits[i].zone()<<setw(15)<<m_hits[i].isX()<<setw(15)<<m_hits[i].dxDy()<<setw(15)<<m_hits[i].dzDy()<<setw(15)<<m_hits[i].cluster().fraction()<<setw(15)<<Chi2Hit(m_hits[i])<<setw(15)<<"Worst"<<std::endl;
        }else{
          std::cout<<i<<setw(15)<<sqrt(1./m_hits[i].w2())<<setw(15)<<m_hits[i].x(0.)<<setw(15)<<m_hits[i].z(0.)<<setw(15)<<m_hits[i].planeCode()<<setw(15)<<m_hits[i].zone()<<setw(15)<<m_hits[i].isX()<<setw(15)<<m_hits[i].dxDy()<<setw(15)<<m_hits[i].dzDy()<<setw(15)<<m_hits[i].cluster().fraction()<<setw(15)<<Chi2Hit(m_hits[i])<<std::endl;
        }
      }
   }
