...
// Fri Jun 26 04:21:23 2015 by ROOT version 5.34/30
// from TTree TrackStudy/Events
// found on file: SciFi-Tuple-Debug_1000.root
//////////////////////////////////////////////////////////

#ifndef TrackStudy_h
#define TrackStudy_h 1
...
class TrackStudy : public TSelector {
  ...
  Double_t        event;
   ...
   Double_t        MC_Ovtx_z;
   Double_t        MC_Charge;
   Bool_t          PhysicsInterestVertex;
   Bool_t          WantedChecker;
   Bool_t          hasT;
   Bool_t          Long;
   Bool_t          LongOver5;
   Bool_t          Long_fromB;
   Bool_t          Long_fromBOver5;
   Bool_t          Down_strange;
   Bool_t          Down_strangeOver5;
   Bool_t          Down_strange_noVelo;
   Bool_t          Down_strange_noVeloOver5;
   Bool_t          Down_strange_fromBD;
   Bool_t          Down_strange_fromBDOver5;
   Bool_t          Down_strange_noVelo_fromBD;
   Bool_t          Down_strange_noVelo_fromDBOver5;
   Bool_t          strange_Long;
   ...
   TBranch        *b_nCluster_SingleLayer;   //!
   ...
   TBranch        *b_MC_Ovtx_z;   //!
   TBranch        *b_MC_Charge;   //!
   TBranch        *b_PhysicsInterestVertex;   //!
   TBranch        *b_WantedChecker;   //!
   TBranch        *b_hasT;   //!
   TBranch        *b_Long;   //!
   TBranch        *b_LongOver5;   //!
   TBranch        *b_Long_fromB;   //!
   TBranch        *b_Long_fromBOver5;   //!
   TBranch        *b_Down_strange;   //!
   TBranch        *b_Down_strangeOver5;   //!
   TBranch        *b_Down_strange_noVelo;   //!
   TBranch        *b_Down_strange_noVeloOver5;   //!
   TBranch        *b_Down_strange_fromBD;   //!
   TBranch        *b_Down_strange_fromBDOver5;   //!
   TBranch        *b_Down_strange_noVelo_fromBD;   //!
   TBranch        *b_Down_strange_noVelo_fromDBOver5;   //!
   ...
   void YforZMatch( PrSeedTrack & fulltrack);
...
private:
   ...
   Int_t m_physical;
   Int_t m_physicalCase0Intrinsic;
   Int_t m_physicalCase0IntrinsicMore4;
   Int_t m_physicalCase0IntrinsicMore5;
...
void TrackStudy::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("nCluster_SingleLayer", &nCluster_SingleLayer, &b_nCluster_SingleLayer);
   ...
   fChain->SetBranchAddress("nMCHits_singleLayer", &nMCHits_singleLayer, &b_nMCHits_singleLayer);
   ...
   fChain->SetBranchAddress("PhysicsInterestVertex", &PhysicsInterestVertex, &b_PhysicsInterestVertex);
   fChain->SetBranchAddress("WantedChecker", &WantedChecker, &b_WantedChecker);
   fChain->SetBranchAddress("hasT", &hasT, &b_hasT);
   fChain->SetBranchAddress("Long", &Long, &b_Long);
   fChain->SetBranchAddress("LongOver5", &LongOver5, &b_LongOver5);
   fChain->SetBranchAddress("Long_fromB", &Long_fromB, &b_Long_fromB);
   fChain->SetBranchAddress("Long_fromBOver5", &Long_fromBOver5, &b_Long_fromBOver5);
   fChain->SetBranchAddress("Down_strange", &Down_strange, &b_Down_strange);
   fChain->SetBranchAddress("Down_strangeOver5", &Down_strangeOver5, &b_Down_strangeOver5);
   fChain->SetBranchAddress("Down_strange_noVelo", &Down_strange_noVelo, &b_Down_strange_noVelo);
   fChain->SetBranchAddress("Down_strange_noVeloOver5", &Down_strange_noVeloOver5, &b_Down_strange_noVeloOver5);
   fChain->SetBranchAddress("Down_strange_fromBD", &Down_strange_fromBD, &b_Down_strange_fromBD);
   fChain->SetBranchAddress("Down_strange_fromBDOver5", &Down_strange_fromBDOver5, &b_Down_strange_fromBDOver5);
   fChain->SetBranchAddress("Down_strange_noVelo_fromBD", &Down_strange_noVelo_fromBD, &b_Down_strange_noVelo_fromBD);
   fChain->SetBranchAddress("Down_strange_noVelo_fromDBOver5", &Down_strange_noVelo_fromDBOver5, &b_Down_strange_noVelo_fromDBOver5);
   ...
   std::cout << "INFO: Successfully initiated" << std::endl;
 }
