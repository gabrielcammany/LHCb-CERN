...
Double_t Radius_Y = 1000.;
Double_t Radius_X = 2000.;
Double_t dRatio_0 = 0.000262;
Double_t dRatio_1 = 1.66e-08;
Double_t dRatio_2 = 1.03e-11;
Double_t dRatioSim_0 = 2.633e-4;
Double_t dRatioSim_1 = -3.59957e-6;
Double_t dRatioSim_2 =  4.7312e-5;
...
TH1D * DeltaRemaining_Case0_T1 = new TH1D("DeltaRemaing_Case0_T1","DeltaRemaining_Case0_T1",500,-5,5);
TH1D * DeltaRemaining_Case0_T2 = new TH1D("DeltaRemaing_Case0_T2","DeltaRemaining_Case0_T2",500,-5,5);
TH1D * DeltaRemaining_Case0_T3 = new TH1D("DeltaRemaing_Case0_T3","DeltaRemaining_Case0_T3",500,-5,5);
...
void TrackStudy::Begin(TTree * /*tree*/){
  ...
  OutputTree = new TTree(OutputTreeName,"Track_Fit");
  
  //-------------------Declaration of the Ntuple and TFile to be filled with the Chi2 Fits on MCHits
   //Y segment fit with XZ fit
  //case 0
  OutputTree->Branch("CConst0",&CConst0,"CConst0/D");
  OutputTree->Branch("angleT1",&angleT1,"angleT1/D");
  OutputTree->Branch("Track_Zone",&Track_Zone,"Track_Zone/I");
  OutputTree->Branch("FitLineY_ay_case0",& FitLineY_ay_case0,"FitLineY_ay_case0/D");
  OutputTree->Branch("FitLineY_by_case0",& FitLineY_by_case0,"FitLineY_by_case0/D");
  OutputTree->Branch("FitLineY_Chi2_case0",& FitLineY_Chi2_case0,"FitLineY_Chi2_case0/D");
  OutputTree->Branch("FitLineY_Chi2DoF_case0",& FitLineY_Chi2DoF_case0,"FitLineY_Chi2DoF_case0/D");
  OutputTree->Branch("BestUV_NHits_case0",& NUV_Case0, "BestUV_NHits_case0/I");

  OutputTree->Branch("FitLineY_ay_case1",& FitLineY_ay_case1,"FitLineY_ay_case1/D");
  OutputTree->Branch("FitLineY_by_case1",& FitLineY_by_case1,"FitLineY_by_case1/D");
  OutputTree->Branch("FitLineY_Chi2_case1",& FitLineY_Chi2_case1,"FitLineY_Chi2_case1/D");
  OutputTree->Branch("FitLineY_Chi2DoF_case1",& FitLineY_Chi2DoF_case1,"FitLineY_Chi2DoF_case1/D");
  OutputTree->Branch("BestUV_NHits_case1",& NUV_Case1, "BestUV_NHits_case1/I");
  
  OutputTree->Branch("FitLineY_ay_case2",& FitLineY_ay_case2,"FitLineY_ay_case2/D");
  OutputTree->Branch("FitLineY_by_case2",& FitLineY_by_case2,"FitLineY_by_case2/D");
  OutputTree->Branch("FitLineY_Chi2_case2",& FitLineY_Chi2_case2,"FitLineY_Chi2_case2/D");
  OutputTree->Branch("FitLineY_Chi2DoF_case2",& FitLineY_Chi2DoF_case2,"FitLineY_Chi2DoF_case2/D");
  OutputTree->Branch("BestUV_NHits_case2",& NUV_Case2, "BestUV_NHits_case2/I");
  
  //Full fit case 0
  OutputTree->Branch("ax_fullFitCase0",&ax_fullFitCase0,"ax_fullFitCase0/D");
  OutputTree->Branch("bx_fullFitCase0",&bx_fullFitCase0,"bx_fullFitCase0/D");
  OutputTree->Branch("cx_fullFitCase0",&cx_fullFitCase0,"cx_fullFitCase0/D");
  OutputTree->Branch("ay_fullFitCase0",&ay_fullFitCase0,"ay_fullFitCase0/D");
  OutputTree->Branch("by_fullFitCase0",&by_fullFitCase0,"by_fullFitCase0/D");
  OutputTree->Branch("Chi2_fullFitCase0",&Chi2_fullFitCase0,"Chi2_fullFitCase0/D");
  OutputTree->Branch("MaxChi2_fullFitCase0",&MaxChi2_fullFitCase0,"MaxChi2_fullFitCase0/D");
  OutputTree->Branch("NHits_fullFitCase0",&NHits_fullFitCase0,"NHits_fullFitCase0/I");
  OutputTree->Branch("y0_fullFitCase0",&y0_fullFitCase0,"y0_fullFitCase0/D");
  

   //Full fit case 1

   OutputTree->Branch("ax_fullFitCase1",&ax_fullFitCase1,"ax_fullFitCase1/D");
   OutputTree->Branch("bx_fullFitCase1",&bx_fullFitCase1,"bx_fullFitCase1/D");
   OutputTree->Branch("cx_fullFitCase1",&cx_fullFitCase1,"cx_fullFitCase1/D");
   OutputTree->Branch("ay_fullFitCase1",&ay_fullFitCase1,"ay_fullFitCase1/D");
   OutputTree->Branch("by_fullFitCase1",&by_fullFitCase1,"by_fullFitCase1/D");
   OutputTree->Branch("Chi2_fullFitCase1",&Chi2_fullFitCase1,"Chi2_fullFitCase1/D");
   OutputTree->Branch("MaxChi2_fullFitCase1",&MaxChi2_fullFitCase1,"MaxChi2_fullFitCase1/D");
   OutputTree->Branch("NHits_fullFitCase1",&NHits_fullFitCase1,"NHits_fullFitCase1/I");
   OutputTree->Branch("y0_fullFitCase1",&y0_fullFitCase1,"y0_fullFitCase1/D");

   //Full fit case 2
   OutputTree->Branch("ax_fullFitCase2",&ax_fullFitCase2,"ax_fullFitCase2/D");
   OutputTree->Branch("bx_fullFitCase2",&bx_fullFitCase2,"bx_fullFitCase2/D");
   OutputTree->Branch("cx_fullFitCase2",&cx_fullFitCase2,"cx_fullFitCase2/D");
   OutputTree->Branch("ay_fullFitCase2",&ay_fullFitCase2,"ay_fullFitCase2/D");
   OutputTree->Branch("by_fullFitCase2",&by_fullFitCase2,"by_fullFitCase2/D");
   OutputTree->Branch("Chi2_fullFitCase2",&Chi2_fullFitCase2,"Chi2_fullFitCase2/D");
   OutputTree->Branch("MaxChi2_fullFitCase2",&MaxChi2_fullFitCase2,"MaxChi2_fullFitCase2/D");
   OutputTree->Branch("NHits_fullFitCase2",&NHits_fullFitCase2,"NHits_fullFitCase2/I");
   OutputTree->Branch("y0_fullFitCase2",&y0_fullFitCase2,"y0_fullFitCase2/D");

   // Fit XZ Case 0 ,1 ,2
   OutputTree->Branch("ax_FitHitCase0_Cub",&ax_FitHitCase0_Cub,"ax_FitHitCase0_Cub/D");
   OutputTree->Branch("bx_FitHitCase0_Cub",&bx_FitHitCase0_Cub,"bx_FitHitCase0_Cub/D");
   OutputTree->Branch("cx_FitHitCase0_Cub",&cx_FitHitCase0_Cub,"cx_FitHitCase0_Cub/D");
   OutputTree->Branch("dx_FitHitCase0_Cub",&dx_FitHitCase0_Cub,"dx_FitHitCase0_Cub/D");

   OutputTree->Branch("ax_FitHitCase0",&ax_FitHitCase0,"ax_FitHitCase0/D");
   OutputTree->Branch("bx_FitHitCase0",&bx_FitHitCase0,"bx_FitHitCase0/D");
   OutputTree->Branch("cx_FitHitCase0",&cx_FitHitCase0,"cx_FitHitCase0/D");
   OutputTree->Branch("ax_FitHitCase1",&ax_FitHitCase1,"ax_FitHitCase1/D");
   OutputTree->Branch("bx_FitHitCase1",&bx_FitHitCase1,"bx_FitHitCase1/D");
   OutputTree->Branch("cx_FitHitCase1",&cx_FitHitCase1,"cx_FitHitCase1/D");
   OutputTree->Branch("ax_FitHitCase2",&ax_FitHitCase2,"ax_FitHitCase2/D");
   OutputTree->Branch("bx_FitHitCase2",&bx_FitHitCase2,"bx_FitHitCase2/D");
   OutputTree->Branch("cx_FitHitCase2",&cx_FitHitCase2,"cx_FitHitCase2/D");

//Solve Parabola Seed 1 /2 Case 0,1,2
   OutputTree->Branch("MaxChi2Hit_Case0",&MaxChi2Hit_Case0,"MaxChi2Hit_Case0/D");
   OutputTree->Branch("MaxChi2Hit_Case1",&MaxChi2Hit_Case1,"MaxChi2Hit_Case1/D");
   OutputTree->Branch("MaxChi2Hit_Case2",&MaxChi2Hit_Case2,"MaxChi2Hit_Case2/D");
   OutputTree->Branch("ax_Case0_Seed1",&ax_Case0_Seed1,"ax_Case0_Seed1/D");
   OutputTree->Branch("bx_Case0_Seed1",&bx_Case0_Seed1,"bx_Case0_Seed1/D");
   OutputTree->Branch("cx_Case0_Seed1",&cx_Case0_Seed1,"cx_Case_Seed1/D");
   OutputTree->Branch("ax_Case0_Seed2",&ax_Case0_Seed2,"ax_Case0_Seed2/D");
   OutputTree->Branch("bx_Case0_Seed2",&bx_Case0_Seed2,"bx_Case0_Seed2/D");
   OutputTree->Branch("cx_Case0_Seed2",&cx_Case0_Seed2,"cx_Case0_Seed2/D");

   OutputTree->Branch("WorstPlane",&WorstPlane,"WorstPlane/I");
   OutputTree->Branch("NbHitsInWorst",&nbHitsInWorst,"NbHitsInWorst/I");
   OutputTree->Branch("ax_Case1_Seed1",&ax_Case1_Seed1,"ax_Case1_Seed1/D");
   OutputTree->Branch("bx_Case1_Seed1",&bx_Case1_Seed1,"bx_Case1_Seed1/D");
   OutputTree->Branch("cx_Case1_Seed1",&cx_Case1_Seed1,"cx_Case1_Seed1/D");
   OutputTree->Branch("ax_Case1_Seed2",&ax_Case1_Seed2,"ax_Case1_Seed2/D");
   OutputTree->Branch("bx_Case1_Seed2",&bx_Case1_Seed2,"bx_Case1_Seed2/D");
   OutputTree->Branch("cx_Case1_Seed2",&cx_Case1_Seed2,"cx_Case1_Seed2/D");

   OutputTree->Branch("ax_Case2_Seed1",&ax_Case2_Seed1,"ax_Case2_Seed1/D");
   OutputTree->Branch("bx_Case2_Seed1",&bx_Case2_Seed1,"bx_Case2_Seed1/D");
   OutputTree->Branch("cx_Case2_Seed1",&cx_Case2_Seed1,"cx_Case2_Seed1/D");

   OutputTree->Branch("ax_Case2_Seed2",&ax_Case2_Seed2,"ax_Case2_Seed2/D");
   OutputTree->Branch("bx_Case2_Seed2",&bx_Case2_Seed2,"bx_Case2_Seed2/D");
   OutputTree->Branch("cx_Case2_Seed2",&cx_Case2_Seed2,"cx_Case2_Seed2/D");

   OutputTree->Branch("Chi2X_Case0",&Chi2X_Case0,"Chi2X_Case0/D");
   //OutputTree->Branch("Chi2X_Case0Cub",&Chi2X_Case0Cub,"Chi2X_Case0Cub/D");


   OutputTree->Branch("Chi2X_Case1",&Chi2X_Case1,"Chi2X_Case1/D");
   OutputTree->Branch("Chi2X_Case2",&Chi2X_Case2,"Chi2X_Case2/D");
   OutputTree->Branch("tx_inf_Case0",&tx_inf_Case0,"tx_inf_Case0/D");
   OutputTree->Branch("tx_inf_Case1",&tx_inf_Case1,"tx_inf_Case1/D");
   OutputTree->Branch("tx_inf_Case2",&tx_inf_Case2,"tx_inf_Case2/D");
   OutputTree->Branch("x0_Case0",&x0_Case0,"x0_Case0/D");
   OutputTree->Branch("x0_Case1",&x0_Case1,"x0_Case1/D");
   OutputTree->Branch("x0_Case2",&x0_Case2,"x0_Case2/D");
   OutputTree->Branch("x_inf_Case0",&x_inf_Case0,"x_inf_Case0/D");
   OutputTree->Branch("x_inf_Case1",&x_inf_Case1,"x_inf_Case1/D");
   OutputTree->Branch("x_inf_Case2",&x_inf_Case2,"x_inf_Case2/D");
   OutputTree->Branch("Del_x_inf_Case0",&Del_x_inf_Case0,"Del_x_inf_Case0/D");
   OutputTree->Branch("Del_x_inf_Case1",&Del_x_inf_Case1,"Del_x_inf_Case1/D");
   OutputTree->Branch("Del_x_inf_Case2",&Del_x_inf_Case2,"Del_x_inf_Case2/D");
   OutputTree->Branch("tx_pickedcombination_Case0",&tx_pickedcombination_Case0,"tx_pickedcombination_Case0/D");
   OutputTree->Branch("tx_pickedcombination_Case1",&tx_pickedcombination_Case1,"tx_pickedcombination_Case1/D");
   OutputTree->Branch("tx_pickedcombination_Case2",&tx_pickedcombination_Case2,"tx_pickedcombination_Case2/D");

   OutputTree->Branch("DelxProjectedSeed1_Case0",&DelxProjectedSeed1_Case0,"DelxProjectedSeed1_Case0/D");
   OutputTree->Branch("DelxProjectedSeed1_Case1",&DelxProjectedSeed1_Case1,"DelxProjectedSeed1_Case1/D");
   OutputTree->Branch("DelxProjectedSeed1_Case2",&DelxProjectedSeed1_Case2,"DelxProjectedSeed1_Case2/D");
   OutputTree->Branch("DelxProjectedSeed2_Case0",&DelxProjectedSeed2_Case0,"DelxProjectedSeed2_Case0/D");
   OutputTree->Branch("DelxProjectedSeed2_Case1",&DelxProjectedSeed2_Case1,"DelxProjectedSeed2_Case1/D");
   OutputTree->Branch("DelxProjectedSeed2_Case2",&DelxProjectedSeed2_Case2,"DelxProjectedSeed2_Case2/D");

   OutputTree->Branch("NX_Case0",&NX_Case0,"NX_Case0/I");
   OutputTree->Branch("NX_Case1",&NX_Case1,"NX_Case1/I");
   OutputTree->Branch("NX_Case2",&NX_Case2,"NX_Case2/I");
   OutputTree->Branch("TypeX",&TypeX,"TypeX/I");

   OutputTree->Branch("Case0Accepted",&Case0Accepted,"Case0Accepted/O");
   OutputTree->Branch("Case1Accepted",&Case1Accepted,"Case1Accepted/O");
   OutputTree->Branch("Case2Accepted",&Case2Accepted,"Case2Accepted/O");
   OutputTree->Branch("PhysicsInterest",&PhysicsInterest,"PhysicsInterest/O");
   OutputTree->Branch("isDown",&ISDOWN,"isDown/O");
   OutputTree->Branch("X0Back",&X0Back,"X0Back/D");
   OutputTree->Branch("ISLONG",&ISLONG,"ISLONG/O");
   OutputTree->Branch("OVTX_Z",&OVTX_Z,"OVTX_Z/D");
   OutputTree->Branch("minCoord",&minCoord,"minCoord/D");
   OutputTree->Branch("maxCoord",&maxCoord,"maxCoord/D");
   OutputTree->Branch("avgCoord",&avgCoord,"avgCoord/D");
   OutputTree->Branch("minY",&minY,"minY/D");
   OutputTree->Branch("maxY",&maxY,"maxY/D");
   OutputTree->Branch("NUV",&NUV,"NUV/I");
   //OutputTree->Branch("nCombT1",nCombT1,"nCombT1/D");
   //OutputTree->Branch("DeltaYT1",)
   OutputTree->Branch("DeltaXT1BestCorrSlopeTy",&DeltaXBestCombCorrSlopeY,"DeltaXT1BestCorrSlopeTy/D");

   OutputTree->Branch("YUT2Projected",&YUT2Projected,"YUT2Projected/D");
   OutputTree->Branch("YVT2Projected",&YVT2Projected,"YVT2Projected/D");
   OutputTree->Branch("DeltaUT2Projected",&DeltaUT2Projected,"DeltaUT2Projected/D");
   OutputTree->Branch("DeltaVT2Projected",&DeltaVT2Projected,"DeltaVT2Projected/D");
   OutputTree->Branch("XPairT1",&XPairT1,"XPairT1/D");
   OutputTree->Branch("YPairT1",&YPairT1,"YPairT1/D");
   OutputTree->Branch("TYPairT1",&TyPairT1,"YPairT1/D");


   OutputTree->Branch("DeltaXBestCombinationT1",&DeltaXBestCombT1,"DeltaXBestCombT1/D");
   OutputTree->Branch("Chi2_XZDRATIOFixed",&Chi2_XZDRATIOFixed,"Chi2_XZDRATIOFixed/D");
   OutputTree->Branch("Chi2_XZDRATIO",&Chi2_XZDRATIO,"Chi2_XZDRATIO/D");
   OutputTree->Branch("Chi2_XStepFit",&Chi2_XStepFit,"Chi2_XStepFit/D");
   OutputTree->Branch("Chi2_perDoF_XStepFit",&Chi2_perDoF_XStepFit,"Chi2_perDoF_XStepFit/d");
   OutputTree->Branch("ax_XStepHitFit",&ax_XStepHitFit,"ax_XStepHitFit/D");
   OutputTree->Branch("bx_XStepHitFit",&bx_XStepHitFit,"bx_XStepHitFit/D");
   OutputTree->Branch("cx_XStepHitFit",&cx_XStepHitFit,"cx_XStepHitFit/D");
   OutputTree->Branch("NHits_XStepHitFit",&NClustersX,"NHits_XStepHitFit/I");
   OutputTree->Branch("NSplittedX",&NSplittedX,"NSplittedX/I");
   OutputTree->Branch("NSplittedUV",&NSplittedUV,"NSplittedUV/I");

   //TH1D * Hist_MCHitContribDuplicate = new TH1D("
   OutputTree->Branch("Chi2_ParabolaXZ",&Chi2_ParabolaXZ,"Chi2_ParabolaXZ/D");
   OutputTree->Branch("ax_parXZ",&ax_par,"ax_parXZ/D");
   OutputTree->Branch("bx_parXZ",&bx_par,"bx_parXZ/D");
   OutputTree->Branch("cx_parXZ",&cx_par,"cx_parXZ/D");
   OutputTree->Branch("Chi2_CubicXZ",&Chi2_CubicXZ,"Chi2_CubicXZ/D");
   OutputTree->Branch("ax_cubXZ",&ax_cub,"ax_cubXZ/D");
   OutputTree->Branch("bx_cubXZ",&bx_cub,"bx_cubXZ/D");
   OutputTree->Branch("cx_cubXZ",&cx_cub,"cx_cubXZ/D");
   OutputTree->Branch("dx_cubXZ",&dx_cub,"dx_cubXZ/D");
   OutputTree->Branch("Z_T3",&Z_T3,"Z_T3/D");
   OutputTree->Branch("Z_T1",&Z_T1,"Z_T1/D");
   OutputTree->Branch("Y_T3",&Y_T3,"Y_T3/D");
   OutputTree->Branch("Y_T1",&Y_T1,"Y_T1/D");
   OutputTree->Branch("X_T3",&X_T3,"X_T3/D");
   OutputTree->Branch("X_T1",&X_T1,"X_T1/D");
   OutputTree->Branch("Coord_T3",&Coord_T3,"Coord_T3/D");
   OutputTree->Branch("Coord_T1",&Coord_T1,"Coord_T1/D");

   OutputTree->Branch("Chi2_LineY",&Chi2_LineY,"Chi2_LineY/D");
   OutputTree->Branch("ay_line",&ay_line,"ay_line/D");
   OutputTree->Branch("by_line",&by_line,"by_line/D");
   OutputTree->Branch("Chi2_ParabolaY",&Chi2_ParabolaY,"Chi2_ParabolaY/D");
   OutputTree->Branch("ay_par",&ay_par,"ay_par/D");
   OutputTree->Branch("by_par",&by_par,"by_par/D");
   OutputTree->Branch("cy_par",&cy_par,"cy_par/D");
   OutputTree->Branch("Track_P",&Momentum,"Track_P/D");
   OutputTree->Branch("Track_Px",&Px,"Track_Px/D");
   OutputTree->Branch("Track_Py",&Py,"Track_Py/D");
   OutputTree->Branch("Track_eta",&Track_eta,"Track_Px/D");
   OutputTree->Branch("Track_Pt",&Track_Pt,"Track_Pt/D");
   OutputTree->Branch("Track_Phi",&Track_Phi,"Track_Phi/D");
   OutputTree->Branch("nPV",&nPV,"nPV/I");
   OutputTree->Branch("isElectron",&IsElectron,"isElectron/O");
   OutputTree->Branch("MCParticleID",&MCParticleiD,"MCParticleID/I");
   OutputTree->Branch("MC_Ovtx_x",&MC_Ovtx_x,"MC_Ovtx_x/D");
   OutputTree->Branch("MC_Ovtx_y",&MC_Ovtx_y,"MC_Ovtx_y/D");
   OutputTree->Branch("MC_Ovtx_z",&MC_Ovtx_z,"MC_Ovtx_z/D");   

   //Remaining XATZ
   OutputTree->Branch("nSeed1Case0Rem",&nRemSeed1_Case0,"nSeed1Case0Rem/I");
   OutputTree->Branch("nSeed2Case0Rem",&nRemSeed2_Case0,"nSeed2Case0Rem/I");
   OutputTree->Branch("DelSeed1_Case0Rem", &DeltaSeed1_Case0,"DelSeed1_Case0Rem[3]/D");
   OutputTree->Branch("DelSeed2_Case0Rem", &DeltaSeed2_Case0,"DelSeed2_Case0Rem[3]/D");

   OutputTree->Branch("nSeed1Case1Rem",&nRemSeed1_Case1,"nSeed1Case1Rem/I");
   OutputTree->Branch("nSeed2Case1Rem",&nRemSeed2_Case1,"nSeed2Case1Rem/I");
   OutputTree->Branch("DelSeed1_Case1Rem", &DeltaSeed1_Case1,"DelSeed1_Case1Rem[3]/D");
   OutputTree->Branch("DelSeed2_Case1Rem", &DeltaSeed2_Case1,"DelSeed2_Case1Rem[3]/D");

   OutputTree->Branch("nSeed1Case2Rem",&nRemSeed1_Case2,"nSeed1Case2Rem/I");
   OutputTree->Branch("nSeed2Case2Rem",&nRemSeed2_Case2,"nSeed2Case2Rem/I");
   OutputTree->Branch("DelSeed1_Case2Rem", &DeltaSeed1_Case2,"DelSeed1_Case2Rem[3]/D");
   OutputTree->Branch("DelSeed2_Case2Rem", &DeltaSeed2_Case2,"DelSeed2_Case2Rem[3]/D");
...
{
   debug = false;
   //   int svg = fChain->GetTree()->GetEntry(entry);
   int svg = fChain->GetEntry(entry);
   if (svg == 0)
     std::cout << "ERROR: Could only read " << svg << " bytes from entry " << entry << std::endl;
   // std::cout<"Processing Entry = "<<entry<<std::endl;
   //Bool_t debug = true;
   if(!(PrHit>1)) return kTRUE;
   if(debug) std::cout<<"Ciao"<<std::endl;
   //   if (not isInVelo and not isInUT)
   //     return false;
   ...
   if( WantedChecker ) m_physical++;
   //if(!PhysicsInterestVertex) return kTRUE;
  if( !WantedChecker ) return kTRUE;
   ...
   for(int i =0;i<PrHit;i++){
      ...
      cluster.setCluster(ChID_Fraction[i],ChID_SipmID[i],ChID_SipmCell[i],ChID_Module[i],ChID_Layer[i],ChID_Mat[i],ChID_Quarter[i]);
   ...
   CConst0 = ( - xProj.ax() + m_zReference*xProj.bx())/xProj.cx();
...
Bool_t TrackStudy::fitXProjectionCubic(PrSeedTrack & track, Bool_t debug)
{
  ...
  for(int loop =0; 3>loop; ++loop){
    ...
    if(!decomp){
      std::cout<<"ERROR: Failed to decompose matrix"<<std::endl;
      return false;
    }
    try{
      decomp.Solve(rhs);
      ...
      std::cout << "ERROR: Something went wrong in the solving" << std::endl;
    }
...
Bool_t TrackStudy::fitXProjection(PrSeedTrack & track, Bool_t debug)
{
   ...
   if(debug) std::cout<<"DEBUG: Hits Size"<<Hits.size()<<std::endl;
   if(debug) std::cout<<"DEBUG: Hits Size from track"<<track.hits().size();
   ...
   for(int loop = 0;3>loop;++loop){
      ...
      for( int i=0;i<Hits.size();i++){
         const float w = Hits[i].w2();
         if(debug) std::cout<<"DEBUG: Hit w2"<<Hits[i].w2()<<std::endl;
         const float dz = Hits[i].z(0.)-m_zReference;
         float deta = dz*dz*(1.+m_dRatio0*dz);
         //if(m_usedRatio){
         //deta = dz*dz*(1-dRatio*dz);
         ...
         if(debug) std::cout<<"DEBUG: i"<<setw(20)<<i<<setw(20)<<"Hit X"<<setw(20)<<Hits[i].x(0)<<setw(20)<<"Track x"<<setw(20)<<track.x(Hits[i].z(0.))<<setw(20)<<"Distance"<< track.distance(Hits[i])<<std::endl;
         mat[0]+= w     ;
         mat[1]+= w * dz;
         mat[2]+= w * dz * dz;
         mat[3]+= w * deta;
...
void TrackStudy::FitHits(Bool_t debug){
   ...
   for (Int_t i = 0 ;  i< CheatedSeeding_NHits; i++){
      ...
      FTCluster cluster;
      //      cluster.setCluster(ChID_Fraction[i],ChID_Charge[i],ChID_SipmID[i],ChID_SipmCell[i],ChID_Module[i],ChID_Layer[i],ChID_Mat[i],ChID_Quarter[i]);
      cluster.setCluster(ChID_Fraction[i],ChID_SipmID[i],ChID_SipmCell[i],ChID_Module[i],ChID_Layer[i],ChID_Mat[i],ChID_Quarter[i]);
   ...
   Double_t Radius = std::sqrt(ay_line*ay_line*(std::abs(ay_line)/Radius_Y) + ax_par*ax_par*(std::abs(ax_par)/Radius_X));
   Double_t dRatio = dRatio_0 + dRatio_1*Radius+dRatio_2*Radius*Radius;
...
bool TrackStudy::XZStudyCase0(PrSeedTrack& xProj, PrSeedTrack& UVSegment,Bool_t debug){
   ...
   std::vector<std::pair<PatHit,Double_t> > ALLREMAININGLAYERSSEED1;
   std::vector<std::pair<PatHit,Double_t> > ALLREMAININGLAYERSSEED2;
   ...
   for( int i = 0; i< PrHit;i++)
   {
      ...
      if(PrHit_isX[i])
      {
         ...
         if( hit.planeCode() == 3 || hit.planeCode() ==7 || hit.planeCode() == 8) {
            ...
            ALLREMAININGLAYERSSEED1.push_back(std::make_pair( hit, -999.));
         }
         ...
         if(  hit.planeCode() == 3 || hit.planeCode() ==4 || hit.planeCode() == 8){
            ...
            ALLREMAININGLAYERSSEED2.push_back(std::make_pair( hit, -999.)) ;
   ...
   if(PrelimSele_Case0)
   {
      ...
      for(int i = 0; i<Case0First.size();i++)
      {
         ...
         for(int j = 0;j<Case0Last.size();j++)
         {
           for(int k=0; k< ParabolaSeedHits1.size();k ++)
           {
             ...
             //if( j == 0 && k ==0 ){
                for( auto& pairhit : ALLREMAININGLAYERSSEED1){
                  double dz = pairhit.first.z()-m_zReference;
                  double delta = pairhit.first.x() - ( a*dz*dz*( 1.+ m_dRatio0*dz) + b*dz + c) ;
                  pairhit.second = delta;
                  if( pairhit.first.planeCode() < 4 && pairhit.first.planeCode() != Case0First[i].planeCode() ){
                     DeltaRemaining_Case0_T1->Fill(  delta  );
                  }else if( pairhit.first.planeCode() < 8 && pairhit.first.planeCode() != ParabolaSeedHits1[k].planeCode() ){
                     DeltaRemaining_Case0_T2->Fill( delta );
                  }else if( pairhit.first.planeCode() < 14 && pairhit.first.planeCode() != Case0Last[j].planeCode() ){
                     DeltaRemaining_Case0_T3->Fill( delta);
                  }
                }
             //}
           ...
           for(int k=0; k< ParabolaSeedHits2.size();k ++)
           {
             ...
             // PatHit hit2_1;
               // PatHit hit3_1;
             std::vector<double> minVal(3);
              for( auto& pairhit : ALLREMAININGLAYERSSEED2){
                  double dz = pairhit.first.z()-m_zReference;
                  double delta = pairhit.first.x() - ( a*dz*dz*( 1.+ m_dRatio0*dz) + b*dz + c) ;
                  pairhit.second = delta;
                  if( pairhit.first.planeCode() < 4 && pairhit.first.planeCode() != Case0First[i].planeCode() ){
                     DeltaRemaining_Case0_T1->Fill(  delta  );
                  }else if( pairhit.first.planeCode() < 8 && pairhit.first.planeCode() != ParabolaSeedHits2[k].planeCode() ){
                     DeltaRemaining_Case0_T2->Fill( delta );
                  }else if( pairhit.first.planeCode() < 14 && pairhit.first.planeCode() != Case0Last[j].planeCode() ){
                     DeltaRemaining_Case0_T3->Fill( delta);
                  }
      ...
      if(OK){
        ...
        //Hardcoded
        Int_t type1 = std::fabs(bestXZ.x(7948.))<500.;
        Int_t type2 = std::fabs(bestXZ.x(9315.))<500.;
        Int_t type = type1+type1+type2;
        // if(type>0){
        ...
        TypeX = type;
        // if(TypeX>2)
        //   std::cout<<"Type X "<<TypeX<<std::endl;
      }
      if(OK2){
      ...
      if(bestXZ.hasHitInPlane(0) && bestXZ.hasHitInPlane(3)){
        angleT1 = std::atan((bestXZ.hitInPlane(3).x(0.)-bestXZ.hitInPlane(0).x(0.))/(bestXZ.hitInPlane(3).z()-bestXZ.hitInPlane(0).z()))*180/3.14;
      }

      // std::cout<<"Type \t"<<TypeX<<std::endl;
      ...
      if(FindBest){ // if you enter here you have removed in one of the layer all the hits
         ...
         if(debug)BestCombination.PrintTrack();
         // std::cout<<"\n \n"<<std::endl;
         // for(layer1){
...
bool TrackStudy::XZStudyCase1( PrSeedTrack& xProj, PrSeedTrack& UVSegment , Bool_t debug){
  ...
  std::vector<int> remainingCase1Seed2N(3,0);
   ...
   if(PrelimSele_Case1){
      ...
      double minChi2 = bestXZ.Chi2()+1.e3;
      PrSeedTrack BestCombination = PrSeedTrack(0, m_zReference);
      if(FindBest){ // if you enter here you have removed in one of the layer all the hits
         for(int i = 0 ; i< HitsUVT1.size();i++){
            if(bestXZ.nHitsInPlane(HitsUVT1[i].planeCode()) == 0){
...
bool TrackStudy::FitSimultaneouslyXY(PrSeedTrack& track,PrSeedTrack& UVSegment,Bool_t debug)
{
   ...
   for(int loop = 0; 10> loop ; ++loop ){
      ...
      if(loop ==1 ){
        float RadiusPosition = std::sqrt((track.ax()*track.ax()/Radius_X/Radius_X + track.y(zRef)*track.y(zRef)/Radius_Y/Radius_Y));
        float dRatioPos = -1.*(dRatioSim_0 + dRatioSim_1*RadiusPosition + dRatioSim_2*RadiusPosition*RadiusPosition);
      ...
      if (!decomp){
        std::cout<<"Failed to decompose matrix Simult fit"<<std::endl;
        return false;
      }
      decomp.Solve(rhs);
      //float yAtZRef = rhs[3];
