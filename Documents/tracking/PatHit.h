...
public:
  ...
  void PrintHit(){
    ...
    std::cout<< "X at 0" << std::setw(20) << "z at 0" << std::setw(20) << "dxDy" << std::setw(20) << "planeCode" <<std::setw(20)<<"zone"<<std::setw(20)<<"fraction"<<std::endl;
    std::cout<< m_xatyEq0 << std::setw(20)<<m_zatyEq0<<std::setw(20)<<m_dxDy<<std::setw(20)<<m_planeCode<<std::setw(20)<<m_zone<<std::setw(20)<<m_Cluster.fraction()<<std::endl; 
  }
